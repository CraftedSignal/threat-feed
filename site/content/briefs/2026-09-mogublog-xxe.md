...
mitre_ttps:
  ...
  - tactic_id: TA0040
    ...
    evidence: Attackers can delete arbitrary comments and their replies by supplying comment UIDs and author UIDs obtained from unauthenticated listing endpoints.
    confidence_band: high
cves:
  - id: CVE-2026-89260
    cvss: 7.5
...
updates:
  - at: "2026-09-11T17:14:41Z"
    level: L2
    summary: added coverage for MoguBlog (<= 6.2)
    sources:
      - nvd
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-89262
