...
mitre_ttps:
  ...
  - tactic_id: TA0005
    ...
    technique_id: T1562
    technique_name: Impair Defenses
    evidence: Detects updates to an Amazon Bedrock guardrail, which may indicate attempts to weaken model safety controls
    confidence_band: high
references:
  ...
  - https://github.com/SigmaHQ/sigma/blob/main/rules/cloud/aws/cloudtrail/aws_cloudtrail_bedrock_guardrail_updated.yml
rules:
  - title: AWS Bedrock Guardrail Deleted
    ...
    data_sources:
      - aws
      - cloudtrail
  - title: Detect AWS Bedrock Guardrail Update
    description: Detects updates to an Amazon Bedrock guardrail, which may indicate attempts to weaken model safety controls and allow unsafe or unauthorized model responses, potentially leading to data exfiltration or policy violations.
    platform: sigma
    severity: medium
    tactics:
      - defense_evasion
...
rules_count: 2
updates:
  - at: "2026-07-27T16:49:58Z"
    level: L1
    summary: 'added detection rule: Detect AWS Bedrock Guardrail Update'
    sources:
      - sigma-hq
    source_urls:
      - https://github.com/SigmaHQ/sigma/blob/main/rules/cloud/aws/cloudtrail/aws_cloudtrail_bedrock_guardrail_updated.yml
