...
cves:
  ...
  - id: CVE-2026-20325
    ...
    cvss: 9.9
references:
  - https://nvd.nist.gov/vuln/detail/CVE-2026-76412
updates:
  - at: "2026-09-16T21:51:28Z"
    level: L2
    summary: added CVE-2026-20343
    sources:
      - nvd
    source_urls:
  ...
  - at: "2026-09-16T21:53:08Z"
    level: L2
    summary: added CVE-2026-20284 +3
    sources:
      - nvd
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-20360
  - at: "2026-09-16T21:53:13Z"
    level: L2
    summary: added CVE-2026-20154 +2
    sources:
      - nvd
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-76412
...
This roundup covers 77 Cisco security vulnerabilities. CVSS base scores range from 4.9 to 9.9. None are reported as actively exploited at the time of release. The issues affect Adaptive Security Appliance Software, AsyncOS Software, BroadWorks CommPilot Application Software, Desk Phone 9800 Series, Identity Services Engine, Nexus 9000 Series Switches, Nexus Dashboard, Secure Adaptive Security Appliance Software, Secure Email, Secure Email Gateway, Secure FMC Software, Secure Firewall Adaptive Security Appliance Software, Secure Firewall Management Center, Secure Firewall Management Center Software, Secure Firewall Threat Defense Software, ThousandEyes Virtual Appliance, UCS Servers.
...
| [CVE-2026-20284](#cve-2026-20284) | Identity Services Engine | Critical | 9.1 |  | no | [source](https://sec.cloudapps.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-ise-mult-vul-ymSsTLCc?vs_f=Cisco%20Security%20Advisory%26vs_cat=Security%20Intelligence%26vs_type=RSS%26vs_p=Cisco%20Identity%20Services%20Engine%20Authenticated%20Remote%20Code%20Execution%20and%20API%20Vulnerabilities%26vs_k=1) (authoritative) |
...
| [CVE-2026-76427](#cve-2026-76427) | Identity Services Engine | Medium | 4.9 |  | no | [source](https://sec.cloudapps.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-ise-multi-hrP9jQSQ?vs_f=Cisco%20Security%20Advisory%26vs_cat=Security%20Intelligence%26vs_type=RSS%26vs_p=Cisco%20Identity%20Services%20Engine%20Vulnerabilities%26vs_k=1) (authoritative) |
...
| [CVE-2026-20176](#cve-2026-20176) | Identity Services Engine | Critical | 9.1 |  | no | [NVD](https://nvd.nist.gov/vuln/detail/CVE-2026-20176) (authoritative) |
| [CVE-2026-20211](#cve-2026-20211) | Identity Services Engine | Critical | 9.1 |  | no | [NVD](https://nvd.nist.gov/vuln/detail/CVE-2026-20211) (authoritative) |
...
| [CVE-2026-20326](#cve-2026-20326) | Nexus Dashboard |  |  |  | no | [NVD](https://nvd.nist.gov/vuln/detail/CVE-2026-20326) (authoritative) |
| [CVE-2026-20361](#cve-2026-20361) | Nexus Dashboard |  |  |  | no | [NVD](https://nvd.nist.gov/vuln/detail/CVE-2026-20361) (authoritative) |
...
Cisco Nexus Dashboard contains an improper access control vulnerability (CWE-284) identified during an internal security review. The vulnerability is rated with a CVSS v3.1 base score of 9.9, indicating a high risk of unauthorized access or security bypass.
...
Related in this roundup: [CVE-2026-20325](#cve-2026-20325), [CVE-2026-20326](#cve-2026-20326), [CVE-2026-20361](#cve-2026-20361), [CVE-2026-20360](#cve-2026-20360), [CVE-2026-76409](#cve-2026-76409).
...
CVE-2026-20326 describes a vulnerability in Cisco Nexus Dashboard resulting from missing authentication for critical functions (CWE-306). This flaw allows an unauthenticated, remote attacker to perform unauthorized actions on the affected system, resulting in a CVSS base score of 9.8.
...
Related in this roundup: [CVE-2026-20322](#cve-2026-20322), [CVE-2026-20325](#cve-2026-20325), [CVE-2026-20361](#cve-2026-20361), [CVE-2026-20360](#cve-2026-20360), [CVE-2026-76409](#cve-2026-76409).

## CVE-2026-20361

Cisco Nexus Dashboard contains a vulnerability that allows for SQL injection due to improper input sanitization, potentially permitting an attacker to execute arbitrary SQL commands against the underlying database.

Affected products:
- Nexus Dashboard

Source: https://nvd.nist.gov/vuln/detail/CVE-2026-20361
...
Cisco Nexus Dashboard contains an information exposure vulnerability (CVE-2026-20360) resulting from insecure handling of data, identified during an internal security review. The vulnerability is classified under CWE-200 and carries a CVSS v3.1 base score of 8.8.
...
Related in this roundup: [CVE-2026-20322](#cve-2026-20322), [CVE-2026-20325](#cve-2026-20325), [CVE-2026-20326](#cve-2026-20326), [CVE-2026-20361](#cve-2026-20361), [CVE-2026-76409](#cve-2026-76409).

## CVE-2026-76409

Cisco Nexus Dashboard contains a vulnerability identified as CVE-2026-76409 related to improper limitation of a pathname (CWE-22). This vulnerability, discovered during an internal security review, requires a software hardening release to mitigate the associated risks, which carry a CVSS v3.1 base score of 8.8.
