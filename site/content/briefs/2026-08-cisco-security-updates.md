...
This roundup covers 33 Cisco security vulnerabilities. CVSS base scores range from 4.8 to 9.8. None are reported as actively exploited at the time of release. The issues affect Adaptive Security Appliance, BroadWorks, Catalyst SD-WAN, Catalyst SD-WAN Manager, ClamAV, IOS Software, IOS XE Software, Industrial Ethernet 1000 Series Switches, Integrated Management Controller, Packaged Contact Center Enterprise, RoomOS, Terminal Services Agent, Unified Intelligence Center.
