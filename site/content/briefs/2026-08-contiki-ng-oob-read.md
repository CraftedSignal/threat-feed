...
mitre_ttps:
  ...
  - tactic_id: TA0002
    ...
    evidence: The overflow allows an arbitrary-pointer-write primitive, which can be leveraged for remote code execution on embedded targets.
    confidence_band: high
cves:
  - id: CVE-2026-5855
    cvss: 7.5
