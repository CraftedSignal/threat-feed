...
mitre_ttps:
  ...
  - tactic_id: TA0002
    ...
    evidence: The vulnerability allows attackers to inject dangerous JVM flags like -agentpath or -javaagent to achieve arbitrary code execution.
    confidence_band: high
cves:
  - id: CVE-2026-78683
    cvss: 9.6
