...
mitre_ttps:
  ...
  - tactic_id: TA0005
    ...
    technique_id: T1059.003
    technique_name: 'Command and Scripting Interpreter: Windows Command Shell'
    evidence: The issue is best described as a filesystem sandbox bypass caused by improper link resolution before file access.
    confidence_band: high
cves:
  - id: CVE-2026-81722
    cvss: 7.5
...
updates:
  ...
  - at: "2026-09-08T20:06:02Z"
    ...
    source_urls:
      - https://github.com/advisories/GHSA-568f-pv23-39p4
  - at: "2026-09-08T20:06:11Z"
    level: L2
    summary: added coverage for NLTK (<= 3.9.3)
    sources:
      - ghsa
    source_urls:
      - https://github.com/advisories/GHSA-r6gq-whwq-mvg9
