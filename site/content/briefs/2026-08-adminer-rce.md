...
rules:
  ...
  - title: Detect CVE-2026-34968 Exploitation Attempt
    ...
    data_sources:
      - webserver
  - title: Detect CVE-2026-56703 Exploitation - SQLite VACUUM INTO Attempt
    description: Detects exploitation attempts against CVE-2026-56703 by searching for the 'VACUUM INTO' command in web server logs, which is used to perform file-based code injection.
    platform: sigma
    severity: high
    tactics:
      - execution
...
updates:
  - at: "2026-08-25T04:05:42Z"
    ...
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-34968
  - at: "2026-08-25T04:05:50Z"
    level: L2
    summary: added coverage for Adminer (< 5.4.3)
    sources:
      - nvd
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-56702
  - at: "2026-08-25T04:06:00Z"
    level: L2
    summary: 'added detection rule: Detect CVE-2026-56703 Exploitation - SQLite VACUUM INTO Attempt'
    sources:
      - nvd
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-56703
