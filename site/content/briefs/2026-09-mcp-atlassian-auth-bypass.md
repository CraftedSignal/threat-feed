...
mitre_ttps:
  ...
  - tactic_id: TA0010
    ...
    evidence: The attacker-controlled URL is injected directly as url= into ConfluenceConfig, constructing a ConfluenceFetcher pointed at the attacker's server.
    confidence_band: high
cves:
  - id: CVE-2026-77244
    cvss: 10
...
updates:
  - at: "2026-09-23T01:57:54Z"
    ...
    source_urls:
      - https://github.com/advisories/GHSA-6529-c226-h328
  - at: "2026-09-23T01:58:10Z"
    level: L2
    summary: 'added detection rule: Detect Unauthorized MCP Tool Execution Attempt'
    sources:
      - ghsa
    source_urls:
      - https://github.com/advisories/GHSA-3r68-hf9h-887v
  ...
  - at: "2026-09-23T01:58:33Z"
    ...
    source_urls:
      - https://github.com/advisories/GHSA-w66g-j6c4-hcfc
  - at: "2026-09-23T01:58:41Z"
    level: L2
    summary: added coverage for mcp-atlassian
    sources:
      - ghsa
    source_urls:
