...
updates:
  - at: "2026-09-15T21:47:24Z"
    level: L2
    summary: added CVE-2026-83054 +1
    sources:
      - nvd
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-83060
...
This roundup covers 53 Oracle security vulnerabilities. CVSS base scores range from 9.1 to 10.0. None are reported as actively exploited at the time of release. The issues affect Fusion Middleware, Identity Manager, Internet Directory, JDeveloper, Managed File Transfer, Oracle Access Manager, Oracle Forms, Oracle Identity Manager, Oracle Identity Manager Connector, Oracle Internet Directory, Service Delivery Platform, WebCenter Enterprise Capture, WebCenter Portal, WebCenter Sites, WebLogic Server.
...
| [CVE-2026-83094](#cve-2026-83094) | Oracle Forms (12.2.1.19.0, 14.1.2.0.0) |  |  |  | no | [NVD](https://nvd.nist.gov/vuln/detail/CVE-2026-83094) (authoritative) |
