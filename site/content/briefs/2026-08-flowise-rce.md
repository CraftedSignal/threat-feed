...
mitre_ttps:
  ...
  - tactic_id: TA0001
    ...
    technique_id: T1592
    technique_name: Gather Victim Org Information
    evidence: An attacker with access to one workspace can supply the credential ID of a target workspace to perform operations on behalf of that workspace.
    confidence_band: high
  - tactic_id: TA0004
    tactic_name: Privilege Escalation
    technique_id: T1059.003
    technique_name: 'Command and Scripting Interpreter: Windows Command Shell'
    evidence: The vulnerability can be leveraged to gain code execution if the service account can modify files such as startup scripts.
    confidence_band: med
cves:
  - id: CVE-2026-69263
    epss: 0.00268
...
updates:
  ...
  - at: "2026-08-04T19:40:48Z"
    ...
    source_urls:
      - https://github.com/advisories/GHSA-8r8h-6vcc-xhrv
  - at: "2026-08-06T23:29:35Z"
    level: L2
    summary: added CVE-2026-70471 +3
    sources:
      - nvd
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-67622
  - at: "2026-08-06T23:31:13Z"
    level: L2
    summary: added CVE-2025-8943 +1
    sources:
      - nvd
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-67621
  - at: "2026-08-08T17:43:54Z"
    level: L2
    summary: added CVE-2026-67620 +1
    sources:
      - nvd
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-67620
