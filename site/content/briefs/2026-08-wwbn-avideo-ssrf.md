...
mitre_ttps:
  ...
  - tactic_id: TA0006
    ...
    technique_name: 'Unsecured Credentials: Password Stores'
    evidence: The endpoint returns complete user records including password hashes, recovery tokens, and live session identifiers.
    confidence_band: high
  - tactic_id: TA0006
    tactic_name: Credential Access
    technique_id: T1185
    technique_name: Browser Session Hijacking
    evidence: Attackers can use the disclosed session identifier to hijack viewer sessions.
    confidence_band: high
  - tactic_id: TA0001
    tactic_name: Initial Access
    technique_id: T1595
    technique_name: Active Scanning
    evidence: The vulnerability allows authenticated users to access other users' restream destinations, enabling the exploitation of the misconfigured service.
    confidence_band: high
  - tactic_id: TA0001
    tactic_name: Initial Access
    technique_id: T1189
    technique_name: Drive-by Compromise
    evidence: Attackers with any valid login account can inject malicious scripts in the User-Agent header that execute in administrator browsers when viewing the Login History page.
    confidence_band: high
  - tactic_id: TA0002
    tactic_name: Execution
    technique_id: T1059.007
    technique_name: 'Command and Scripting Interpreter: JavaScript'
    evidence: the payload then executes in the browser of any visitor, including administrators
    confidence_band: high
  - tactic_id: TA0001
    tactic_name: Initial Access
    technique_id: T1566
    technique_name: Phishing
    evidence: The script triggers the generation of a live password-recovery token for any targeted account, which is sent to the account owner via email.
    confidence_band: high
  - tactic_id: TA0003
    tactic_name: Persistence
    technique_id: T1078
    technique_name: Valid Accounts
    evidence: An attacker can exploit this to... ultimately leading to unauthorized account takeover via objects/userRecoverPassSave.json.php.
    confidence_band: high
cves:
  - id: CVE-2026-82648
    cvss: 7.1
references:
  ...
  - https://nvd.nist.gov/vuln/detail/CVE-2026-86720
  ...
  - https://nvd.nist.gov/vuln/detail/CVE-2026-92915
rules:
  ...
  - title: Detect CVE-2026-84478 Exploitation - Path Traversal in AVideo API
    ...
    data_sources:
      - webserver
  - title: Detect CVE-2026-86189 Exploitation Attempt - Path Traversal in AVideo
    description: Detects exploitation attempts against notify.ffmpeg.json.php using path traversal sequences in the avideoRelativePath parameter.
    platform: sigma
    severity: critical
    tactics:
      - initial_access
    ...
    data_sources:
      - webserver
  - title: Detect CVE-2026-86729 Exploitation - High-Frequency Access to get_api_preauthorize
    description: Detects potential brute-force attempts against the unthrottled get_api_preauthorize API endpoint by identifying an anomalous volume of POST requests to the plugin path.
    platform: sigma
    severity: high
    tactics:
      - credential_access
    ...
    data_sources:
      - webserver
  - title: Detect CVE-2026-86720 Exploitation - Unauthorized Access to resendRestreamer.json.php
    description: Detects potential exploitation of CVE-2026-86720 by monitoring for repeated POST requests to the vulnerable script that may indicate parameter manipulation.
    platform: sigma
    severity: high
    tactics:
      - initial_access
    ...
    data_sources:
      - webserver
  - title: Detect CVE-2026-92582 Exploitation - CSRF Attempt on videoAddNew.json.php
    description: Detects exploitation attempts against CVE-2026-92582 by identifying HTTP requests to videoAddNew.json.php that include both user and pass parameters in the query string, which trigger the CSRF protection bypass.
    platform: sigma
    severity: high
    tactics:
      - initial_access
...
updates:
  - at: "2026-09-10T15:11:13Z"
    level: L2
    summary: added coverage for AVideo (<= commit c3edcc274c389816d434acadac07ee78eaf330c1)
    sources:
      - nvd
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-88866
  - at: "2026-09-10T15:11:58Z"
    level: L2
    ...
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-88867
  - at: "2026-09-16T23:52:58Z"
    level: L1
    summary: 'added detection rule: Detect CVE-2026-92582 Exploitation - CSRF Attempt on videoAddNew.json.php'
    sources:
      - nvd
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-92582
  - at: "2026-09-17T03:52:53Z"
    ...
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-92578
  - at: "2026-09-17T13:57:09Z"
    level: L1
    summary: added coverage for AVideo (<= commit e01e41ecc)
    sources:
      - nvd
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-92915
