...
mitre_ttps:
  ...
  - tactic_id: TA0040
    ...
    evidence: A single request holds one event-loop thread for seconds; a handful of concurrent requests can saturate CPU and stall the process.
    confidence_band: high
cves:
  - id: CVE-2026-83617
    epss: 0.00328
...
updates:
  - at: "2026-09-08T21:51:00Z"
    ...
    source_urls:
      - https://github.com/advisories/GHSA-3px3-54cx-rmw9
  - at: "2026-09-08T21:52:48Z"
    level: L1
    summary: added coverage for xmldom (<= 0.6.0) +1 products
    sources:
      - ghsa
    source_urls:
      - https://github.com/advisories/GHSA-8344-3jmq-59r6
