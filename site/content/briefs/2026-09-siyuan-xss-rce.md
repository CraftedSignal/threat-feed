...
mitre_ttps:
  ...
  - tactic_id: TA0001
    ...
    evidence: Attackers can supply crafted notebooks... to inject malicious style values
    confidence_band: med
  - tactic_id: TA0002
    tactic_name: Execution
    technique_id: T1059
    technique_name: Command and Scripting Interpreter
    evidence: execute in the Electron renderer with full system access
    confidence_band: med
cves:
  - id: CVE-2026-92985
    cvss: 8.8
