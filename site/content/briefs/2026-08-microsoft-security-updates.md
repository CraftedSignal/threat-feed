...
cves:
  ...
  - id: CVE-2026-68118
    epss: 0.00166
references:
  - https://msrc.microsoft.com/update-guide/vulnerability/CVE-2026-58650
updates:
  ...
  - at: "2026-08-11T17:48:48Z"
    level: L2
    summary: added CVE-2026-50472, CVE-2026-56174
    sources:
      - msrc
    source_urls:
      - https://msrc.microsoft.com/update-guide/vulnerability/CVE-2026-50472
      - https://msrc.microsoft.com/update-guide/vulnerability/CVE-2026-56174
  - at: "2026-08-11T17:49:07Z"
    level: L2
    summary: added CVE-2026-64590 +1
    sources:
      - msrc
    source_urls:
      - https://msrc.microsoft.com/update-guide/vulnerability/CVE-2026-58650
...
This roundup covers 67 Microsoft security vulnerabilities. CVSS base scores range from 8.8 to 9.8. None are reported as actively exploited at the time of release. The issues affect AMT, Application Insights Profiler, Azure Active Directory, Azure Confidential Ledger, Azure Logic Apps, Azure SQL Managed Instance, Azure SRE Agent, Azure Service Bus, Bluetooth, Dynamics Business Central, HDF5, Microsoft 365 Admin Center, Microsoft Entra Provisioning Service, Microsoft Planetary Computer Pro, Microsoft Purview eDiscovery, Microsoft Teams, Power Apps, Rpm, SMB Client, SharePoint Online, Windows, Windows Narrator, dma-buf/udmabuf, firmware, ims-pcu, iomap, ksmbd, mctp, net/handshake, pds_core, wanxl.
