...
mitre_ttps:
  ...
  - tactic_id: TA0002
    ...
    evidence: An authenticated user with any database role can submit a parameterized Gremlin query to trigger the Groovy fallback and execute arbitrary operating system commands.
    confidence_band: high
cves:
  - id: CVE-2026-75846
    cvss: 7.1
...
updates:
  - at: "2026-08-19T14:35:16Z"
    ...
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-76223
  - at: "2026-08-19T14:35:22Z"
    level: L2
    summary: added coverage for ArcadeDB +1 products
    sources:
      - nvd
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-76224
