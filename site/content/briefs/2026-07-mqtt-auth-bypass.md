...
products:
  ...
  - CHARX SEC-3050
  - CHARX SEC-3000
  - CHARX SEC-3150 (< 1.9.1)
  - CHARX SEC-3100 (< 1.9.1)
  - CHARX SEC-3050 (< 1.9.1)
  - CHARX SEC-3000 (< 1.9.1)
mitre_ttps:
  - tactic_id: TA0001
  ...
  - tactic_id: TA0003
    ...
    evidence: This could allow the attacker to gain SSH access to the system as an unprivileged user 'user-app'.
    confidence_band: high
cves:
  - id: CVE-2026-44090
    cvss: 9.8
...
references:
  ...
  - https://nvd.nist.gov/vuln/detail/CVE-2026-44094
  - https://nvd.nist.gov/vuln/detail/CVE-2026-44096
  - https://nvd.nist.gov/vuln/detail/CVE-2026-44097
  - https://nvd.nist.gov/vuln/detail/CVE-2026-44099
  - https://nvd.nist.gov/vuln/detail/CVE-2026-44106
  - https://nvd.nist.gov/vuln/detail/CVE-2026-44107
rules:
  - title: Detect Unauthorized MQTT Connection to Phoenix CHARX Controllers
    ...
    data_sources:
      - network_connection
  - title: Detect CVE-2026-44097 Exploitation Attempt
    description: Detects potential exploitation attempts by monitoring for POST requests to the firmware update REST endpoint on Phoenix Contact CHARX controllers.
    platform: sigma
    severity: medium
    tactics:
      - initial_access
...
rules_count: 2
updates:
  - at: "2026-07-30T08:13:29Z"
    level: L2
    summary: 'merged source coverage: Unauthenticated Remote Firmware Partition Fallback in Phoenix Contact CHARX Controllers'
    sources:
      - nvd
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-44094
  - at: "2026-07-30T08:13:44Z"
    level: L2
    summary: 'merged source coverage: Privilege Escalation in Phoenix Contact CHARX Controllers via udhcpc'
    sources:
      - nvd
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-44096
  - at: "2026-07-30T08:13:52Z"
    level: L1
    summary: 'added detection rule: Detect CVE-2026-44097 Exploitation Attempt'
    sources:
      - nvd
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-44097
  - at: "2026-07-30T08:14:03Z"
    level: L2
    summary: added CVE-2026-44091 +10; charx sec-3000 version < 1.9.1; charx sec-3150 version < 1.9.1; charx sec-3100 version < 1.9.1; charx sec-3050 version < 1.9.1
    sources:
      - nvd
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-44099
  - at: "2026-07-30T08:14:13Z"
    level: L1
    summary: 'merged source coverage: Unauthenticated Denial of Service in Phoenix Contact CHARX Controllers'
    sources:
      - nvd
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-44107
