...
mitre_ttps:
  ...
  - tactic_id: TA0001
    ...
    evidence: A malicious or compromised RDP server sending a crafted RAIL Window Alternate Secondary Order with WINDOW_ORDER_ICON can trigger use-after-free.
    confidence_band: high
cves:
  - id: CVE-2026-67288
    cvss: 7.5
...
updates:
  - at: "2026-08-01T13:52:02Z"
    ...
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-67296
  - at: "2026-08-01T13:52:21Z"
    level: L2
    summary: 'merged source coverage: FreeRDP Client-Side Heap Use-After-Free Vulnerability'
    sources:
      - nvd
    source_urls:
  ...
  - at: "2026-08-01T13:52:23Z"
    ...
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-67300
  - at: "2026-08-01T13:52:28Z"
    level: L1
    summary: 'merged source coverage: FreeRDP Out-of-Bounds Read Vulnerability'
    sources:
      - nvd
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-67301
  - at: "2026-08-01T13:52:31Z"
    level: L2
    summary: added CVE-2026-67301
    sources:
      - nvd
    source_urls:
      - https://nvd.nist.gov/vuln/detail/CVE-2026-67304
