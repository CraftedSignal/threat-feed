...
mitre_ttps:
  ...
  - tactic_id: TA0006
    ...
    evidence: Attackers with page-edit permission can use config.get() or config.toArray() in Twig templates to retrieve sensitive values like system.cache.redis.password.
    confidence_band: high
cves:
  - id: CVE-2026-72819
    cvss: 8.8
